...
Veškerá konfigurace probíhá prostřednictvím webového rozhraní, které umožňuje nastavit až 64 různých parametrů. Firmware podporuje více způsobů odesílání dat, včetně HTTP GET, MQTT a APRS. V případě HTTP GET lze data odesílat až na tři různé servery. Možnost spínání až 3 GPIO výstupů podle naměřených hodnot. K dispozici je rovněž podpora logování na syslog server nebo do sériového rozhraní. Jednotlivé funkce lze nezávisle zapínat či vypínat podle potřeb uživatele.
